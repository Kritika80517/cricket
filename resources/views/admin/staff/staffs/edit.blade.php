            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form class="form-horizontal" action="{{ route('admin.staffs.update', $staff->id) }}" method="POST"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        value="{{ $staff->user->contact }}" class="form-control" required>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="role_id" required class="form-control aiz-selectpicker">
                                            @foreach ($roles as $role)
                                                <option  @php if($staff->role_id == $role->id) echo "selected"; @endphp value="{{ $role->id }}">{{ $role->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-control" name="status" id="status">
                                            <option @if ($staff->user->status == 1) selected @endif value="1">Active</option>
                                            <option @if ($staff->user->status == 0) selected @endif  value="0">Inactive</option>
                                        </select>
                                    </div>
                                </div>
