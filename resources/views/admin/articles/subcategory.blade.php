                                            ...
                                            @foreach ($article as $key => $item)
                                                <tr style="align-items: center">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ url('admin/articles/categories/delete/' . $item->id) }}" class="btn btn-danger btn-action mr-1" data-toggle="tooltip" title="delete" onclick="return confirm('Are you sure want to delete this user?')"><i class="fas fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
