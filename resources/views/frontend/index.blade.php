...
.play-button-overlay {
    ...
    align-items: center;
    pointer-events: none; /* Prevents interference with click events on the image */
}
...
<div class="full-slider">
    <div id="carousel-example-generic" class="carousel slide">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item {{$key == 0 ? 'active' : ''}}" style="background-image:url('{{'assets/admin/img/banners/'.$banner->image}}');" data-ride="carousel" data-interval="5000">
                ...
                <div class="matchs-vs">
                    <div class="vs-team">
                        <div class="team-btw-match">
                            <ul>
                                <li>
                                    <img src="{{asset('assets/frontend/images/img-03.png')}}" alt="">
                                    <span>Footbal Team</span>
                                </li>
                                <li class="vs"><span>vs</span></li>
                                <li>
                                    <img src="{{asset('assets/frontend/images/img-04.png')}}" alt="">
            ...
            <div class="col-lg-4 col-sm-4 col-xs-12">
                <aside id="sidebar" class="left-bar">
                    <div class="banner-sidebar">
                        <img class="img-responsive" src="{{asset('assets/frontend/images/img-05.jpg')}}" alt="#" />
                ...
                <aside id="sidebar" class="left-bar">
                    <div class="feature-matchs">
                        <div class="team-btw-match">
                            ...
                            <li class="vs"><span>vs</span></li>
                            <li>
                                <img src="{{asset('assets/frontend/images/img-04_003.png')}}" alt="">
                                <span>Germany</span>
                            </li>
                            </ul>
                            <ul>
                                <li>
                                    <img src="{{asset('assets/frontend/images/img-05_002.png')}}" alt="">
                                    <span>Portugal</span>
                                </li>
                                <li class="vs"><span>vs</span></li>
                                <li>
                            ...
                            <ul>
                                <li>
                                    <img src="{{asset('assets/frontend/images/img-07_002.png')}}" alt="">
                                    <span>Portugal</span>
                                </li>
                                <li class="vs"><span>vs</span></li>
                                <li>
                                    <img src="{{asset('assets/frontend/images/img-08.png')}}" alt="">
                                    <span>Germany</span>
                                </li>
                            </ul>
                            <ul>
                    ...
                    <div class="feature-matchs">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td><img src="{{asset('assets/frontend/images/img-01_004.png')}}" alt="">Liverpool</td>
                                    <td>10</td>
                                    <td>12</td>
                                    <td>20</td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td><img src="{{asset('assets/frontend/images/img-02_002.png')}}" alt="">Chelsea</td>
                                    <td>10</td>
                                    <td>12</td>
                                    <td>20</td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td><img src="{{asset('assets/frontend/images/img-03_003.png')}}" alt="">Norwich City</td>
                                    <td>20</td>
                                    <td>15</td>
                                    <td>20</td>
                                </tr>
                                <tr>
                                    <td>4</td>
                                    <td><img src="{{asset('assets/frontend/images/img-04_002.png')}}" alt="">West Brom</td>
                                    <td>60</td>
                                    <td>10</td>
                                    <td>60</td>
                                </tr>
                                <tr>
                                    <td>5</td>
                                    <td><img src="{{asset('assets/frontend/images/img-05.png')}}" alt="">sunderland</td>
                                    <td>30</td>
                                    <td>06</td>
                                    <td>30</td>
                                </tr>
            ...
            <div class="col-lg-8 col-sm-8 col-xs-12">
                <div class="news-post-holder">
                    <div class="news-post-widget">
                        <img class="img-responsive" src="{{asset('assets/frontend/images/img-01_002.jpg')}}" alt="">
                    ...
                    <div class="news-post-widget">
                        <img class="img-responsive" src="{{asset('assets/frontend/images/img-02_003.jpg')}}" alt="">
                        <div class="news-post-detail">
                            <span class="date">20 march 2016</span>
                            <h2><a href="blog-detail.html">At vero eos et accusamus et iusto odio dignissimos ducimus</a></h2>
                            <p>Just hours after that his grandma had died, Angel Di Maria imagined how she might react if he didn't play</p>
                ...
                <div class="news-post-holder">
                    <div class="news-post-widget">
                        <img class="img-responsive" src="{{asset('assets/frontend/images/img-03_003.jpg')}}" alt="">
                        <div class="news-post-detail">
                            <span class="date">20 march 2016</span>
                            <h2><a href="blog-detail.html">At vero eos et accusamus et iusto odio dignissimos ducimus</a></h2>
                            <p>Just hours after that his grandma had died, Angel Di Maria imagined how she might react if he didn't play</p>
            ...
            <div class="col-md-12">
                <div class="full">
                    <div class="match_vedio">
                        <img class="img-responsive" style="width: 100%" src="{{asset("assets/admin/img/matchhighlight/video/".$item->image)}}" alt="#" />
...
<section class="video_section_main theme-padding middle-bg vedio">
    <div id="carousel-example-generic2" class="carousel slide">
        ...
        <ol class="carousel-indicators">
            ...
            <li data-target="#carousel-example-generic2" data-slide-to="{{ $key }}" class="{{ $key == 0 ? 'active' : '' }}"></li>
            @endforeach
        </ol>
        <!-- Wrapper for slides -->
        <div class="carousel-inner" role="listbox">
            @foreach ($data['video'] as $key => $item)
            <div class="item {{$key == 0 ? 'active' : ''}}" data-ride="carousel" data-interval="5000">
                <div style="display: flex; justify-content: center; position: relative;">
                    <iframe src="{{$item->video_url}}" frameborder="0" style="display: none;" class="video-frame"></iframe>
                    <img class="img-responsive video-thumbnail" style="width: 75%; cursor: pointer;" src="{{ asset('assets/admin/img/matchhighlight/video/' . $item->image) }}" alt="#" />
                    <div class="play-button-overlay" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
                        <img src="{{ asset('path/to/play-button.png') }}" alt="Play Button" style="width: 50px; height: 50px;">
                    </div>
                </div>
            </div>
            @endforeach
...
<script>
    ...
    $('.video-thumbnail').on('click', function() {
        ...
        var $videoFrame = $parent.find('.video-frame');
        $(this).hide(); // Hide the image
        $parent.find('.play-button-overlay').hide(); // Hide the play button
        $videoFrame.show(); // Show the video
    });
});
