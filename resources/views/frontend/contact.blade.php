                        ...
                        <div class="contact-info card">
                            ...
                            <div class="kode-forminfo">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                                    ut labore et dolore magna aliqua. Ut enim ad minim veniam aliquip..</p>
                                <ul class="kode-form-list">
                                    <li>
                                        <i class="fa fa-home"></i>
                                        <p><strong>Address:</strong> 805 consectetur adipiscing elit, sed do eiusmod tempor
                                        </p>
                                    </li>
                                    <li>
                    ...
                    <div class="col-md-6">
                        <div class="contact-us card">
                            <form method="POST" action="{{ url('contact/submit') }}" class="comments-form">
                                @csrf
                                <ul>
                                    <li><input type="text" id="name" name="name" class="required"
                                            placeholder="Name *"></li>
                                ...
                                <div class="d-flex justify-content-center w-100">
                                    <button class="btn btn-danger" style="float: none" type="submit"
                                                        ...
                                                        <div class="contact-info">
                                                            ...
                                                            <div class="kode-forminfo">
                                                                ...
                                                                <ul class="kode-form-list">
                                                                    <li>
                                                                        <i class="fa fa-home"></i>
                                                                        <p><strong>Address:</strong> 805 consectetur
                                                            ...
                                                            <form method="POST" action="{{ url('contact/submit') }}"
                                                                ...
                                                                <ul>
                                                                    <li><input type="text" id="name" name="name"
                                                                            class="required" placeholder="Name *"></li>
                                                                ...
                                                                <div class="d-flex justify-content-center w-100">
                                                                    <button class="btn btn-danger" style="float: none"
